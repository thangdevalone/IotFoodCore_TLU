...
const SearchList = () => {
  ...
  const [search, setSearch] = React.useState<string>(`${queryParams.key || ""}`)
  ...
  return (
    <Box>
      ...
      <Box
        sx={{
          boxShadow: setterShadow
            ? "0 4px 2px -2px rgba(0, 0, 0, 0.2)"
            : "none",
        }}
        className={`z-[100] pb-2 w-full bg-white  sticky ${
          width < 500 ? "top-[60px]" : "top-[80px] "
        }`}
      >
